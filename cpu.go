...
func (c *CPU) buildLookupTable() {
	...
	c.lookup[0xA9] = Instruction{Name: "LDA", Operate: LDA, AddrMode: IMM, Cycles: 2}
	c.lookup[0xA5] = Instruction{Name: "LDA", Operate: LDA, AddrMode: ZP0, Cycles: 3}
	c.lookup[0xB5] = Instruction{Name: "LDA", Operate: LDA, AddrMode: ZPX, Cycles: 4}
	c.lookup[0xAD] = Instruction{Name: "LDA", Operate: LDA, AddrMode: ABS, Cycles: 4}
	c.lookup[0xBD] = Instruction{Name: "LDA", Operate: LDA, AddrMode: ABX, Cycles: 4}
	c.lookup[0xB9] = Instruction{Name: "LDA", Operate: LDA, AddrMode: ABY, Cycles: 4}
	c.lookup[0xA1] = Instruction{Name: "LDA", Operate: LDA, AddrMode: IZX, Cycles: 6}
	c.lookup[0xB1] = Instruction{Name: "LDA", Operate: LDA, AddrMode: IZY, Cycles: 5}

	c.lookup[0xA2] = Instruction{Name: "LDX", Operate: LDX, AddrMode: IMM, Cycles: 2}
	c.lookup[0xA6] = Instruction{Name: "LDX", Operate: LDX, AddrMode: ZP0, Cycles: 3}
	c.lookup[0xB6] = Instruction{Name: "LDX", Operate: LDX, AddrMode: ZPY, Cycles: 4}
	c.lookup[0xAE] = Instruction{Name: "LDX", Operate: LDX, AddrMode: ABS, Cycles: 4}
	c.lookup[0xBE] = Instruction{Name: "LDX", Operate: LDX, AddrMode: ABY, Cycles: 4}

	c.lookup[0xA0] = Instruction{Name: "LDY", Operate: LDY, AddrMode: IMM, Cycles: 2}
	c.lookup[0xA4] = Instruction{Name: "LDY", Operate: LDY, AddrMode: ZP0, Cycles: 3}
	c.lookup[0xB4] = Instruction{Name: "LDY", Operate: LDY, AddrMode: ZPX, Cycles: 4}
	c.lookup[0xAC] = Instruction{Name: "LDY", Operate: LDY, AddrMode: ABS, Cycles: 4}
	c.lookup[0xBC] = Instruction{Name: "LDY", Operate: LDY, AddrMode: ABX, Cycles: 4}

	c.lookup[0x85] = Instruction{Name: "STA", Operate: STA, AddrMode: ZP0, Cycles: 3}
	c.lookup[0x95] = Instruction{Name: "STA", Operate: STA, AddrMode: ZPX, Cycles: 4}
	c.lookup[0x8D] = Instruction{Name: "STA", Operate: STA, AddrMode: ABS, Cycles: 4}
	c.lookup[0x9D] = Instruction{Name: "STA", Operate: STA, AddrMode: ABX, Cycles: 5}
	c.lookup[0x99] = Instruction{Name: "STA", Operate: STA, AddrMode: ABY, Cycles: 5}
	c.lookup[0x81] = Instruction{Name: "STA", Operate: STA, AddrMode: IZX, Cycles: 6}
	c.lookup[0x91] = Instruction{Name: "STA", Operate: STA, AddrMode: IZY, Cycles: 6}

	c.lookup[0x86] = Instruction{Name: "STX", Operate: STX, AddrMode: ZP0, Cycles: 3}
	c.lookup[0x96] = Instruction{Name: "STX", Operate: STX, AddrMode: ZPY, Cycles: 4}
	c.lookup[0x8E] = Instruction{Name: "STX", Operate: STX, AddrMode: ABS, Cycles: 4}

	c.lookup[0x84] = Instruction{Name: "STY", Operate: STY, AddrMode: ZP0, Cycles: 3}
	c.lookup[0x94] = Instruction{Name: "STY", Operate: STY, AddrMode: ZPX, Cycles: 4}
	c.lookup[0x8C] = Instruction{Name: "STY", Operate: STY, AddrMode: ABS, Cycles: 4}

	c.lookup[0xAA] = Instruction{Name: "TAX", Operate: TAX, AddrMode: IMP, Cycles: 2}
	c.lookup[0xA8] = Instruction{Name: "TAY", Operate: TAY, AddrMode: IMP, Cycles: 2}
	c.lookup[0xBA] = Instruction{Name: "TSX", Operate: TSX, AddrMode: IMP, Cycles: 2}
	c.lookup[0x8A] = Instruction{Name: "TXA", Operate: TXA, AddrMode: IMP, Cycles: 2}
	c.lookup[0x9A] = Instruction{Name: "TXS", Operate: TXS, AddrMode: IMP, Cycles: 2}
	c.lookup[0x98] = Instruction{Name: "TYA", Operate: TYA, AddrMode: IMP, Cycles: 2}

	c.lookup[0x48] = Instruction{Name: "PHA", Operate: PHA, AddrMode: IMP, Cycles: 3}
	c.lookup[0x08] = Instruction{Name: "PHP", Operate: PHP, AddrMode: IMP, Cycles: 3}
	c.lookup[0x68] = Instruction{Name: "PLA", Operate: PLA, AddrMode: IMP, Cycles: 4}
	c.lookup[0x28] = Instruction{Name: "PLP", Operate: PLP, AddrMode: IMP, Cycles: 4}

	c.lookup[0x69] = Instruction{Name: "ADC", Operate: ADC, AddrMode: IMM, Cycles: 2}
	c.lookup[0x65] = Instruction{Name: "ADC", Operate: ADC, AddrMode: ZP0, Cycles: 3}
	c.lookup[0x75] = Instruction{Name: "ADC", Operate: ADC, AddrMode: ZPX, Cycles: 4}
	c.lookup[0x6D] = Instruction{Name: "ADC", Operate: ADC, AddrMode: ABS, Cycles: 4}
	c.lookup[0x7D] = Instruction{Name: "ADC", Operate: ADC, AddrMode: ABX, Cycles: 4}
	c.lookup[0x79] = Instruction{Name: "ADC", Operate: ADC, AddrMode: ABY, Cycles: 4}
	c.lookup[0x61] = Instruction{Name: "ADC", Operate: ADC, AddrMode: IZX, Cycles: 6}
	c.lookup[0x71] = Instruction{Name: "ADC", Operate: ADC, AddrMode: IZY, Cycles: 5}

	c.lookup[0xE9] = Instruction{Name: "SBC", Operate: SBC, AddrMode: IMM, Cycles: 2}
	c.lookup[0xE5] = Instruction{Name: "SBC", Operate: SBC, AddrMode: ZP0, Cycles: 3}
	c.lookup[0xF5] = Instruction{Name: "SBC", Operate: SBC, AddrMode: ZPX, Cycles: 4}
	c.lookup[0xED] = Instruction{Name: "SBC", Operate: SBC, AddrMode: ABS, Cycles: 4}
	c.lookup[0xFD] = Instruction{Name: "SBC", Operate: SBC, AddrMode: ABX, Cycles: 4}
	c.lookup[0xF9] = Instruction{Name: "SBC", Operate: SBC, AddrMode: ABY, Cycles: 4}
	c.lookup[0xE1] = Instruction{Name: "SBC", Operate: SBC, AddrMode: IZX, Cycles: 6}
	c.lookup[0xF1] = Instruction{Name: "SBC", Operate: SBC, AddrMode: IZY, Cycles: 5}

	c.lookup[0xE6] = Instruction{Name: "INC", Operate: INC, AddrMode: ZP0, Cycles: 5}
	c.lookup[0xF6] = Instruction{Name: "INC", Operate: INC, AddrMode: ZPX, Cycles: 6}
	c.lookup[0xEE] = Instruction{Name: "INC", Operate: INC, AddrMode: ABS, Cycles: 6}
	c.lookup[0xFE] = Instruction{Name: "INC", Operate: INC, AddrMode: ABX, Cycles: 7}
	c.lookup[0xE8] = Instruction{Name: "INX", Operate: INX, AddrMode: IMP, Cycles: 2}
	c.lookup[0xC8] = Instruction{Name: "INY", Operate: INY, AddrMode: IMP, Cycles: 2}

	c.lookup[0xC6] = Instruction{Name: "DEC", Operate: DEC, AddrMode: ZP0, Cycles: 5}
	c.lookup[0xD6] = Instruction{Name: "DEC", Operate: DEC, AddrMode: ZPX, Cycles: 6}
	c.lookup[0xCE] = Instruction{Name: "DEC", Operate: DEC, AddrMode: ABS, Cycles: 6}
	c.lookup[0xDE] = Instruction{Name: "DEC", Operate: DEC, AddrMode: ABX, Cycles: 7}
	c.lookup[0xCA] = Instruction{Name: "DEX", Operate: DEX, AddrMode: IMP, Cycles: 2}
	c.lookup[0x88] = Instruction{Name: "DEY", Operate: DEY, AddrMode: IMP, Cycles: 2}

	c.lookup[0x0A] = Instruction{Name: "ASL", Operate: ASL, AddrMode: IMP, Cycles: 2}
	c.lookup[0x06] = Instruction{Name: "ASL", Operate: ASL, AddrMode: ZP0, Cycles: 5}
	c.lookup[0x16] = Instruction{Name: "ASL", Operate: ASL, AddrMode: ZPX, Cycles: 6}
	c.lookup[0x0E] = Instruction{Name: "ASL", Operate: ASL, AddrMode: ABS, Cycles: 6}
	c.lookup[0x1E] = Instruction{Name: "ASL", Operate: ASL, AddrMode: ABX, Cycles: 7}

	c.lookup[0x4A] = Instruction{Name: "LSR", Operate: LSR, AddrMode: IMP, Cycles: 2}
	c.lookup[0x46] = Instruction{Name: "LSR", Operate: LSR, AddrMode: ZP0, Cycles: 5}
	c.lookup[0x56] = Instruction{Name: "LSR", Operate: LSR, AddrMode: ZPX, Cycles: 6}
	c.lookup[0x4E] = Instruction{Name: "LSR", Operate: LSR, AddrMode: ABS, Cycles: 6}
	c.lookup[0x5E] = Instruction{Name: "LSR", Operate: LSR, AddrMode: ABX, Cycles: 7}

	c.lookup[0x2A] = Instruction{Name: "ROL", Operate: ROL, AddrMode: IMP, Cycles: 2}
	c.lookup[0x26] = Instruction{Name: "ROL", Operate: ROL, AddrMode: ZP0, Cycles: 5}
	c.lookup[0x36] = Instruction{Name: "ROL", Operate: ROL, AddrMode: ZPX, Cycles: 6}
	c.lookup[0x2E] = Instruction{Name: "ROL", Operate: ROL, AddrMode: ABS, Cycles: 6}
	c.lookup[0x3E] = Instruction{Name: "ROL", Operate: ROL, AddrMode: ABX, Cycles: 7}

	c.lookup[0x6A] = Instruction{Name: "ROR", Operate: ROR, AddrMode: IMP, Cycles: 2}
	c.lookup[0x66] = Instruction{Name: "ROR", Operate: ROR, AddrMode: ZP0, Cycles: 5}
	c.lookup[0x76] = Instruction{Name: "ROR", Operate: ROR, AddrMode: ZPX, Cycles: 6}
	c.lookup[0x6E] = Instruction{Name: "ROR", Operate: ROR, AddrMode: ABS, Cycles: 6}
	c.lookup[0x7E] = Instruction{Name: "ROR", Operate: ROR, AddrMode: ABX, Cycles: 7}

	c.lookup[0x29] = Instruction{Name: "AND", Operate: AND, AddrMode: IMM, Cycles: 2}
	c.lookup[0x25] = Instruction{Name: "AND", Operate: AND, AddrMode: ZP0, Cycles: 3}
	c.lookup[0x35] = Instruction{Name: "AND", Operate: AND, AddrMode: ZPX, Cycles: 4}
	c.lookup[0x2D] = Instruction{Name: "AND", Operate: AND, AddrMode: ABS, Cycles: 4}
	c.lookup[0x3D] = Instruction{Name: "AND", Operate: AND, AddrMode: ABX, Cycles: 4}
	c.lookup[0x39] = Instruction{Name: "AND", Operate: AND, AddrMode: ABY, Cycles: 4}
	c.lookup[0x21] = Instruction{Name: "AND", Operate: AND, AddrMode: IZX, Cycles: 6}
	c.lookup[0x31] = Instruction{Name: "AND", Operate: AND, AddrMode: IZY, Cycles: 5}

	c.lookup[0x49] = Instruction{Name: "EOR", Operate: EOR, AddrMode: IMM, Cycles: 2}
	c.lookup[0x45] = Instruction{Name: "EOR", Operate: EOR, AddrMode: ZP0, Cycles: 3}
	c.lookup[0x55] = Instruction{Name: "EOR", Operate: EOR, AddrMode: ZPX, Cycles: 4}
	c.lookup[0x4D] = Instruction{Name: "EOR", Operate: EOR, AddrMode: ABS, Cycles: 4}
	c.lookup[0x5D] = Instruction{Name: "EOR", Operate: EOR, AddrMode: ABX, Cycles: 4}
	c.lookup[0x59] = Instruction{Name: "EOR", Operate: EOR, AddrMode: ABY, Cycles: 4}
	c.lookup[0x41] = Instruction{Name: "EOR", Operate: EOR, AddrMode: IZX, Cycles: 6}
	c.lookup[0x51] = Instruction{Name: "EOR", Operate: EOR, AddrMode: IZY, Cycles: 5}

	c.lookup[0x09] = Instruction{Name: "ORA", Operate: ORA, AddrMode: IMM, Cycles: 2}
	c.lookup[0x05] = Instruction{Name: "ORA", Operate: ORA, AddrMode: ZP0, Cycles: 3}
	c.lookup[0x15] = Instruction{Name: "ORA", Operate: ORA, AddrMode: ZPX, Cycles: 4}
	c.lookup[0x0D] = Instruction{Name: "ORA", Operate: ORA, AddrMode: ABS, Cycles: 4}
	c.lookup[0x1D] = Instruction{Name: "ORA", Operate: ORA, AddrMode: ABX, Cycles: 4}
	c.lookup[0x19] = Instruction{Name: "ORA", Operate: ORA, AddrMode: ABY, Cycles: 4}
	c.lookup[0x01] = Instruction{Name: "ORA", Operate: ORA, AddrMode: IZX, Cycles: 6}
	c.lookup[0x11] = Instruction{Name: "ORA", Operate: ORA, AddrMode: IZY, Cycles: 5}

	c.lookup[0x24] = Instruction{Name: "BIT", Operate: BIT, AddrMode: ZP0, Cycles: 3}
	c.lookup[0x2C] = Instruction{Name: "BIT", Operate: BIT, AddrMode: ABS, Cycles: 4}

	c.lookup[0xC9] = Instruction{Name: "CMP", Operate: CMP, AddrMode: IMM, Cycles: 2}
	c.lookup[0xC5] = Instruction{Name: "CMP", Operate: CMP, AddrMode: ZP0, Cycles: 3}
	c.lookup[0xD5] = Instruction{Name: "CMP", Operate: CMP, AddrMode: ZPX, Cycles: 4}
	c.lookup[0xCD] = Instruction{Name: "CMP", Operate: CMP, AddrMode: ABS, Cycles: 4}
	c.lookup[0xDD] = Instruction{Name: "CMP", Operate: CMP, AddrMode: ABX, Cycles: 4}
	c.lookup[0xD9] = Instruction{Name: "CMP", Operate: CMP, AddrMode: ABY, Cycles: 4}
	c.lookup[0xC1] = Instruction{Name: "CMP", Operate: CMP, AddrMode: IZX, Cycles: 6}
	c.lookup[0xD1] = Instruction{Name: "CMP", Operate: CMP, AddrMode: IZY, Cycles: 5}

	c.lookup[0xE0] = Instruction{Name: "CPX", Operate: CPX, AddrMode: IMM, Cycles: 2}
	c.lookup[0xE4] = Instruction{Name: "CPX", Operate: CPX, AddrMode: ZP0, Cycles: 3}
	c.lookup[0xEC] = Instruction{Name: "CPX", Operate: CPX, AddrMode: ABS, Cycles: 4}

	c.lookup[0xC0] = Instruction{Name: "CPY", Operate: CPY, AddrMode: IMM, Cycles: 2}
	c.lookup[0xC4] = Instruction{Name: "CPY", Operate: CPY, AddrMode: ZP0, Cycles: 3}
	c.lookup[0xCC] = Instruction{Name: "CPY", Operate: CPY, AddrMode: ABS, Cycles: 4}

	c.lookup[0x90] = Instruction{Name: "BCC", Operate: BCC, AddrMode: REL, Cycles: 2}
	c.lookup[0xB0] = Instruction{Name: "BCS", Operate: BCS, AddrMode: REL, Cycles: 2}
	c.lookup[0xF0] = Instruction{Name: "BEQ", Operate: BEQ, AddrMode: REL, Cycles: 2}
	c.lookup[0x30] = Instruction{Name: "BMI", Operate: BMI, AddrMode: REL, Cycles: 2}
	c.lookup[0xD0] = Instruction{Name: "BNE", Operate: BNE, AddrMode: REL, Cycles: 2}
	c.lookup[0x10] = Instruction{Name: "BPL", Operate: BPL, AddrMode: REL, Cycles: 2}
	c.lookup[0x50] = Instruction{Name: "BVC", Operate: BVC, AddrMode: REL, Cycles: 2}
	c.lookup[0x70] = Instruction{Name: "BVS", Operate: BVS, AddrMode: REL, Cycles: 2}

	c.lookup[0x4C] = Instruction{Name: "JMP", Operate: JMP, AddrMode: ABS, Cycles: 3}
	c.lookup[0x6C] = Instruction{Name: "JMP", Operate: JMP, AddrMode: IND, Cycles: 5}
	c.lookup[0x20] = Instruction{Name: "JSR", Operate: JSR, AddrMode: ABS, Cycles: 6}
	c.lookup[0x60] = Instruction{Name: "RTS", Operate: RTS, AddrMode: IMP, Cycles: 6}

	c.lookup[0x00] = Instruction{Name: "BRK", Operate: BRK, AddrMode: IMP, Cycles: 7}
	c.lookup[0x40] = Instruction{Name: "RTI", Operate: RTI, AddrMode: IMP, Cycles: 6}

	c.lookup[0x18] = Instruction{Name: "CLC", Operate: CLC, AddrMode: IMP, Cycles: 2}
	c.lookup[0xD8] = Instruction{Name: "CLD", Operate: CLD, AddrMode: IMP, Cycles: 2}
	c.lookup[0x58] = Instruction{Name: "CLI", Operate: CLI, AddrMode: IMP, Cycles: 2}
	c.lookup[0xB8] = Instruction{Name: "CLV", Operate: CLV, AddrMode: IMP, Cycles: 2}
	c.lookup[0x38] = Instruction{Name: "SEC", Operate: SEC, AddrMode: IMP, Cycles: 2}
	c.lookup[0xF8] = Instruction{Name: "SED", Operate: SED, AddrMode: IMP, Cycles: 2}
	c.lookup[0x78] = Instruction{Name: "SEI", Operate: SEI, AddrMode: IMP, Cycles: 2}
